...
const TodoCard = ({
  ...
  return (
    <div
      ...
      {...listeners}
      {...attributes}
      className="cursor-grab rounded-2xl bg-white hover:border-[2px] border-gray p-4 flex flex-col   gap-2 justify-center items-start  shadow-sm hover:shadow-md "
      style={style}
    >
      ...
      <div className="flex relative  w-full mt-3 gap-3  flex-col items-start lg:flex-row justify-between lg:items-center">
        <div className="flex   justify-center items-center ">
          <img
            src={img1}
            alt="logo"
            className="w-[25px] absolute left-0 h-[25px] rounded-full z-30"
          />
          <img
            src={img4}
            alt="logo"
            className="w-[25px] absolute left-4 h-[25px] rounded-full z-20"
          />
          <img
            src={img3}
            alt="logo"
            className="w-[25px]  absolute left-8 h-[25px] rounded-full z-10"
          />
        </div>
